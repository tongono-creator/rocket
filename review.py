...
ROLES = [
    {"id": "R1", "name": "ผู้ชายวัยทำงาน", "desc": "มองประโยชน์สำหรับผู้ชายวัย 35-60 จากข้อมูลจริง ไม่แต่งว่าเคยใช้"},
    {"id": "R2", "name": "ของใช้ในบ้าน", "desc": "มองว่าสินค้าช่วยงานบ้าน งานช่าง หรือชีวิตประจำวันด้านใด"},
    {"id": "R3", "name": "เทียบก่อนซื้อ", "desc": "ชี้ราคาและฟังก์ชันที่ควรเทียบก่อนตัดสินใจ"},
    {"id": "R4", "name": "ชี้พิกัดแบบกลางๆ", "desc": "บอกประเภท จุดเด่น และราคา ไม่เร่งซื้อและไม่สร้างประสบการณ์สมมติ"}
]
...
def upload_image_to_imgbb(img_path):
    ...
    try:
        ...
        if res.get("success"):
            ...
            print(f"[Threads] ImgBB upload failed: {res}")
    except Exception as e:
...
if __name__ == "__main__":
    ...
    # Two review days/week; workflow starts 18:50 and schedules the post for 19:10 BKK.
    slot_times = ["19:10"]
    slot_timestamps = []

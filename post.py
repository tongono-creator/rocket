...
TEXT_MODELS       = ["gemini-flash-latest", "gemini-flash-latest"]  # fallback order
OUTPUT_DIR        = "output"
...
def generate_story(topic, slot="morning"):
    ...
    if slot == "morning":
        dilemma_context = "ประเด็นดราม่าชีวิตออฟฟิศ การงาน เพื่อนร่วมงาน หรือเจ้านายชวนบ่น"
    elif slot == "noon":
        dilemma_context = "ปัญหาความกลืนไม่เข้าคายไม่ออกเรื่องการเงิน การผ่อนของ หนี้สิน ครอบครัว หรือความสัมพันธ์ในวัยทำงาน"
    elif slot == "evening":
        dilemma_context = "ประเด็นการเปรียบเทียบค่าใช้จ่ายหรือการเลือกใช้ชีวิตการเงิน 2 ฝั่ง (เช่น การผ่อนรถ VS การนั่งรถสาธารณะ)"
    else:
        dilemma_context = "สัจธรรมความจริงของชีวิตสร้างตัว การแบกรับภาระครอบครัว หรือความเหนื่อยล้าของคนทำงานวัย 30+"

    prompt = (
        "เขียน caption Facebook ภาษาไทยสำหรับเพจ Rocket21 โดยเล่าประเด็นดราม่าชีวิตจริง\n\n"
        f"ประเด็นหลัก/หัวข้อ: {topic}\n"
        f"บริบทแนวทางโพสต์: {dilemma_context}\n\n"
        "เป้าหมาย:\n"
        "ให้คนอ่านแล้วรู้สึกอิน อยากเข้ามาร่วมคอมเมนต์แสดงความคิดเห็นและถกเถียงทันที เหมือนอ่านกระทู้เล่าเรื่องชีวิตจริงในคอมมูนิตี้คนทำงาน\n\n"
        "กฎเหล็กสำคัญ:\n"
        "- เขียนเล่าเรื่องในมุมมองบุคคลที่หนึ่ง เหมือนคนจริงมาโพสต์แชร์เรื่องราว/ปัญหาของตนเองลงกลุ่ม ไม่ใช่ภาษาเขียนเรียงความ ไม่ใช่ภาษาข่าว และไม่สุภาพแบบประดิษฐ์ประดอย\n"
        "- ความยาวแบ่งเป็น 3-4 ย่อหน้าสั้นๆ (แยกด้วยการเว้นบรรทัด เพื่อให้อ่านง่ายบนมือถือ)\n"
        "- เปิดเรื่องด้วยสถานการณ์ที่เห็นภาพชัดเจนทันที\n"
        "- ต้องชูความขัดแย้ง (Conflict) ของเรื่องให้โดดเด่น เช่น เรื่องเงิน เพื่อน ครอบครัว ความเกรงใจ หรือสัจธรรมชีวิตคนทำงาน\n"
        "- ห้ามใช้ bullet points (เช่น •) หรือมีขีดแดชนำหน้าบรรทัดเด็ดขาด\n"
        "- ห้ามใส่ hashtag ใดๆ ทั้งสิ้นในเนื้อหา\n"
        "- ห้ามใช้คำวิชาการ หรือคำโฆษณา/บอต เช่น ดราม่า, ช็อก, ไวรัล, ปัญหาสังคม\n"
        "- ห้ามเขียนสรุปสอนศีลธรรม คติเตือนใจ หรือสอนบทเรียนให้ผู้อ่าน\n"
        "- ใช้ภาษาสไตล์ผู้ชายที่เป็นกันเองและสุภาพพอดีตัว แทนตัวเองด้วย 'ผม' หรือ 'พี่' และลงท้ายด้วย 'ครับ/ผม/ครับพี่' หรือ 'พี่ๆ' ตามธรรมชาติ\n"
        "- ต้องมีประโยคที่ทำให้อ่านแล้วรู้สึกว่า 'เรื่องนี้เกิดกับใครก็ได้ หรืออาจเกิดกับตัวเราเองได้'\n"
        "- ตอนจบย่อหน้าสุดท้าย ต้องยิงคำถามปิดท้ายเชิงบังคับเลือกข้าง หรือถามจุดยืนที่ชัดเจนและจี้ใจเพื่อให้คนแสดงความเห็น (เช่น 'ควรทวงไหม หรือควรตัดเพื่อนไปเลยครับ?', 'ถ้าเป็นพี่ๆ จะยอมเสียเงินหรือเสียเพื่อน?', 'แบบนี้ควรทนต่อหรือลาออกดีครับ?')\n\n"
        "โครงสร้างเนื้อความ:\n"
        "ย่อหน้า 1: เล่าเกริ่นสถานการณ์สั้นๆ\n"
        "ย่อหน้า 2: ชี้จุดเจ็บ (Pain point) หรือความอึดอัดไม่แฟร์ของเหตุการณ์\n"
        "ย่อหน้า 3: เล่าความลังเลใจหรือความกลืนไม่เข้าคายไม่ออก\n"
        "ย่อหน้าสุดท้าย: ตั้งคำถามดึงดูดคอมเมนต์\n\n"
...
def post_facebook(img_path, caption):
    print("Posting to Facebook (using two-step publish)...")
    try:

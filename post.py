...
CONTENT_STYLES = [
    # style 0: Financial Mindset / Social Realities (ประเด็นสังคมและการเงิน)
    (
        "เขียนประโยคข้อคิดหรือความจริงตลกร้ายเกี่ยวกับวินัยทางการเงิน/ค่านิยมสังคมวัยทำงานจากหัวข้อ: {topic}\n"
        ...
        "ใช้ภาษาพูดปกติ ไม่เอาคำนำหรือป้ายกำกับใดๆ เช่น 'บรรทัด 1:'\n"
...
def generate_story(topic, slot="morning"):
    ...
    prompt = (
        ...
        "เขียนรวมเป็นย่อหน้าสั้นๆ ต่อเนื่องกัน ภาษาพูดธรรมดาคนวัย 30-45 สรรพนามแทนตัวเองด้วย ผม หรือ พี่ และลงท้ายสุภาพครับ/ผม "

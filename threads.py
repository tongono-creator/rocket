...
CONTENT_STYLES = [
    # style 0: Work/Boss/Coworker Dilemmas (ดราม่าชีวิตทำงาน - บุคคลที่ 3 อ่านเจอจากโซเชียล/Reddit)
    (
        "คุณคือแอดมินเพจที่เป็น 'บุคคลที่สาม' (3rd-Party Observer/Curator) ที่ไปอ่านเจอเรื่องราวหรือกระทู้ดราม่าการทำงานจาก Reddit หรือโซเชียล แล้วนำมาเล่าต่อชวนลูกเพจคุย\n"
        "หัวข้อ: {topic}\n\n"
        "กฎเหล็กการเขียน:\n"
        "1. วางตัวเป็นบุคคลที่สามที่ไปอ่านเจอมาเท่านั้น! ห้ามแต่งเรื่องว่าเป็นประสบการณ์ส่วนตัวของแอดมินเองเด็ดขาด\n"
        "2. บรรทัดแรกต้องขึ้นต้นด้วยการอ้างอิงแหล่งที่มา เช่น 'ไปเจอโพสต์หนึ่งใน Reddit น่าสนใจมากครับ...', 'มีชาวเน็ตมาตั้งกระทู้ถามเกี่ยวกับเรื่องงานว่า...'\n"
        "3. สรุปทางเลือกหรือดราม่า 2 ฝั่ง ด้วยภาษาพูดคนไทยธรรมดา สไตล์ CatDumb อ่านง่าย ไม่เกิน 70 ตัวอักษรรวม\n"
        "4. บรรทัดสองเป็นคำถามชวนลูกเพจคอมเมนต์ เช่น 'ควรทนต่อหรือถอยดีครับ?', 'เป็นคุณจะเลือกแบบไหนครับ?'\n"
        "5. ใช้ภาษาพูดผู้ชาย สุภาพแต่เป็นกันเอง (ใช้ 'ครับ') ห้ามมีป้ายกำกับ ท้ายใส่ 2 hashtag"
    ),
    # style 1: Financial Dilemma (กระทู้ดราม่าการเงิน/ครอบครัว/แฟน - บุคคลที่ 3 อ่านเจอจากโซเชียล/Reddit)
    (
        "คุณคือแอดมินเพจที่เป็น 'บุคคลที่สาม' ที่ไปอ่านเจอกระทู้ดราม่าการเงิน/ความสัมพันธ์จาก Reddit หรือโซเชียลมาเล่าต่อ\n"
        "หัวข้อ: {topic}\n\n"
        "กฎเหล็กการเขียน:\n"
        "1. วางตัวเป็นบุคคลที่สามที่ไปอ่านเจอมาเท่านั้น! ห้ามอ้างว่าเป็นเรื่องของตัวเอง\n"
        "2. ขึ้นต้นอ้างอิงการไปอ่านเจอมา เช่น 'ไปอ่านเจอดราม่าเรื่องนี้ใน Reddit น่าคิดมากครับ...', 'มีโพสต์หนึ่งแชร์เรื่องเงินกับแฟนไว้ว่า...'\n"
        "3. เล่าประเด็นทางเลือกความคุ้มค่าเป็นภาษาพูดคนไทย ธรรมชาติ ไม่เกิน 75 ตัวอักษรรวม\n"
        "4. ปิดท้ายด้วยคำถามชวนคอมเมนต์ เช่น 'เป็นคุณจะยอมไหมครับ?', 'คิดว่าแบบไหนคุ้มกว่ากันครับ?'\n"
        "5. ใช้ภาษาพูดผู้ชาย (ใช้ 'ครับ') ห้ามมีป้ายกำกับ ท้ายใส่ 2 hashtag"
    ),
    # style 2: Comparison/Team Selection (ศึกเลือกทีม/เปรียบเทียบชีวิต - บุคคลที่ 3 อ่านเจอมา)
    (
        "คุณคือแอดมินเพจที่เป็น 'บุคคลที่สาม' ที่ไปอ่านเจอประเด็นเปรียบเทียบเลือกฝั่งจาก Reddit หรือโซเชียลมาเล่าชวนคุย\n"
        "หัวข้อ: {topic}\n\n"
        "กฎเหล็กการเขียน:\n"
        "1. วางตัวเป็นบุคคลที่สามที่ไปอ่านเจอประเด็นนี้มาเท่านั้น! ห้ามแต่งว่าเป็นเรื่องส่วนตัว\n"
        "2. ขึ้นต้นอ้างอิงการไปอ่านเจอมา เช่น 'ไปเจอกระทู้เปรียบเทียบอันนี้น่าสนใจใน Reddit...', 'มีชาวเน็ตตั้งประเด็นถกกันว่า...'\n"
        "3. สรุปการเปรียบเทียบสองฝั่งชัดเจน ด้วยภาษาพูดตลกเป็นกันเอง ไม่เกิน 75 ตัวอักษรรวม\n"
        "4. ปิดท้ายด้วยคำถามเลือกทีม เช่น 'ทีมไหนรายงานตัวหน่อยครับ?', 'แบบไหนรอดง่ายกว่ากันครับ?'\n"
        "5. ใช้ภาษาพูดผู้ชาย (ใช้ 'ครับ') ห้ามมีป้ายกำกับ ท้ายใส่ 2 hashtag"
    ),
    # style 3: Sarcastic Struggles (ประชดชีวิตผู้ใหญ่ 30+ - บุคคลที่ 3 อ่านเจอมา)
    (
        "คุณคือแอดมินเพจที่เป็น 'บุคคลที่สาม' ที่ไปอ่านเจอประโยคตลกร้าย/ประชดชีวิตจาก Reddit หรือโซเชียลมาเล่าต่อ\n"
        "หัวข้อ: {topic}\n\n"
        "กฎเหล็กการเขียน:\n"
        "1. วางตัวเป็นบุคคลที่สามที่ไปอ่านเจอเรื่องนี้มาเท่านั้น!\n"
        "2. ขึ้นต้นอ้างอิงการอ่านเจอมา เช่น 'ไปอ่านเจอโพสต์ประชดชีวิตอันนี้น่าคิดมากครับ...', 'มีชาวเน็ตคนหนึ่งบ่นไว้ว่า...'\n"
        "3. เล่าสัจธรรมผู้ใหญ่ประชดชีวิตด้วยภาษาพูดคนไทย อ่านแล้วพยักหน้าตาม ไม่เกิน 70 ตัวอักษรรวม\n"
        "4. ปิดท้ายด้วยคำถามจี้ใจ เช่น 'บ้านไหนเจอแบบนี้บ้างครับ?', 'เห็นด้วยไหมครับ?'\n"
        "5. ใช้ภาษาพูดผู้ชาย (ใช้ 'ครับ') ห้ามมีป้ายกำกับ ท้ายใส่ 2 hashtag"
    ),
]
def clean_text(text):
...
def clean_hook_lines(raw_text):
    ...
    return "\n".join(cleaned_lines)
FALLBACK_QUOTES = [
    "พนักงานวัย 30+ คนหนึ่งบอกว่า สิ่งที่น่าตื่นเต้นที่สุดไม่ใช่เงินเดือนออก\nแต่คือตื่นมาแล้วหลังไม่ปวดครับ\n#ชีวิตคนทำงาน",
    "พนักงานคนหนึ่งเพิ่งรู้ว่า เสียงแจ้งเตือน LINE สั่งงานตอนสี่ทุ่ม\nทำร้ายใจยิ่งกว่างานด่วนตอนเช้าครับ\n#ชีวิตมนุษย์เงินเดือน",
    "มนุษย์ออฟฟิศคนหนึ่งทำงานหนักเหมือนเป็นเจ้าของบริษัท\nแต่วันเงินเดือนออกกลับรู้สึกเหมือนเป็นผู้บริจาคครับ\n#ชีวิตมนุษย์ออฟฟิศ",
    "ชายวัย 35 คนหนึ่งมีรายได้เพิ่มขึ้นทุกปี\nแต่เวลาพักกลับลดลงทุกเดือน แบบนี้คุ้มจริงไหมครับ\n#ชีวิตคนทำงาน",
    "พนักงานคนหนึ่งเก็บเงินก้อนแรกได้สำเร็จ\nแต่ครอบครัวกลับขอยืมทั้งหมด เคสนี้ควรให้ไหมครับ\n#เรื่องเงินเรื่องใหญ่",
    "คู่รักคู่หนึ่งมีรายได้รวมกันสูง\nแต่ซ่อนหนี้กันคนละก้อน แบบนี้ยังควรกู้บ้านร่วมกันไหมครับ\n#ชีวิตคู่",
    "หญิงคนหนึ่งอยากมี passive income เดือนละหมื่น\nแต่เงินสำรองยังไม่พอใช้หนึ่งเดือน ควรเริ่มลงทุนหรือเก็บเงินสดก่อนครับ\n#วางแผนการเงิน",
    "พนักงานคนหนึ่งยอมแลกสุขภาพกับเงินเดือนมาหลายปี\nสุดท้ายเงินที่เก็บได้กลับต้องนำไปจ่ายค่ารักษาครับ\n#ถนอมสุขภาพ"
]

THIRD_PERSON_FALLBACKS = {
    "morning": [
        {
            "image_line1": "เงินเดือนขึ้น",
            "image_line2": "เงินเก็บไม่โต",
            "caption": "พนักงานวัย 35 คนหนึ่งได้เงินเดือนเพิ่ม แต่ภาระที่บ้านเพิ่มเร็วกว่าจนแทบไม่เหลือเก็บ เคสนี้ควรลดภาระหรือเร่งหารายได้เพิ่มครับ?",
            "seed_comment": "เคสนี้ควรกันเงินฉุกเฉินก่อน แล้วค่อยช่วยครอบครัวตามกำลังครับ",
        },
        {
            "image_line1": "งานมั่นคง",
            "image_line2": "แต่ใจไม่ไหว",
            "caption": "ชายคนหนึ่งมีงานประจำมั่นคง แต่ตื่นมาพร้อมความเครียดทุกวัน ถ้ารายได้ดีแต่สุขภาพใจพัง ควรทนต่อหรือลาออกครับ?",
            "seed_comment": "ถ้าความเครียดกระทบการนอนและสุขภาพทุกวัน เคสนี้ควรวางแผนหางานใหม่ครับ",
        },
    ],
    "noon": [
        {
            "image_line1": "ให้เงินพ่อแม่",
            "image_line2": "จนไม่เหลือเก็บ",
            "caption": "ลูกคนหนึ่งให้เงินพ่อแม่ทุกเดือนจนตัวเองไม่มีเงินฉุกเฉิน หากลดจำนวนลงก็ถูกมองว่าไม่กตัญญู แบบนี้ควรตั้งขอบเขตไหมครับ?",
            "seed_comment": "ความกตัญญูไม่ควรทำให้ลูกต้องเป็นหนี้ เคสนี้ควรช่วยเท่าที่กำลังไหวครับ",
        },
        {
            "image_line1": "แฟนมีหนี้",
            "image_line2": "ควรไปต่อไหม",
            "caption": "หญิงคนหนึ่งเพิ่งรู้ว่าแฟนมีหนี้ซ่อนอยู่หลายแสนบาท ทั้งคู่กำลังจะกู้ซื้อบ้านร่วมกัน ควรหยุดแผนหรือให้โอกาสครับ?",
            "seed_comment": "หนี้ที่ปิดบังคือปัญหาเรื่องความไว้ใจ เคสนี้ควรหยุดแผนกู้ร่วมไว้ก่อนครับ",
        },
    ],
    "evening": [
        {
            "image_line1": "ซื้อบ้านไกล",
            "image_line2": "เช่าใกล้งาน",
            "caption": "พนักงานคนหนึ่งกำลังเลือกระหว่างซื้อบ้านชานเมืองกับเช่าคอนโดใกล้ที่ทำงาน ถ้าต้องแลกเงินกับเวลา แบบไหนคุ้มกว่าครับ?",
            "seed_comment": "ถ้ายังไม่แน่ใจว่าจะทำงานที่เดิมนานแค่ไหน เคสนี้เช่าใกล้งานคล่องตัวกว่าครับ",
        },
        {
            "image_line1": "ซื้อรถใหม่",
            "image_line2": "หรือเงินก้อน",
            "caption": "ชายคนหนึ่งมีเงินดาวน์รถพอดี แต่เงินก้อนนั้นคือเงินสำรองทั้งหมด ควรได้ความสะดวกตอนนี้หรือเก็บความมั่นคงไว้ครับ?",
            "seed_comment": "ถ้าซื้อแล้วเงินสำรองเป็นศูนย์ เคสนี้ควรเก็บเงินก้อนไว้ก่อนครับ",
        },
    ],
    "late": [
        {
            "image_line1": "งานยังเดิน",
            "image_line2": "แต่ร่างกายพัง",
            "caption": "พนักงานคนหนึ่งทำงานล่วงเวลาจนเริ่มป่วยบ่อย แต่ยังไม่กล้าพักเพราะกลัวรายได้หาย สุขภาพกับงานควรเลือกอะไรก่อนครับ?",
            "seed_comment": "งานเปลี่ยนได้ แต่สุขภาพบางอย่างย้อนกลับไม่ได้ เคสนี้ควรพักและพบแพทย์ก่อนครับ",
        },
        {
            "image_line1": "อายุใกล้ 40",
            "image_line2": "แต่ไร้วันหยุด",
            "caption": "ชายวัยใกล้ 40 คนหนึ่งใช้เวลาทั้งหมดไปกับงานและภาระครอบครัว จนแทบไม่มีวันหยุดให้ตัวเอง ควรฝืนต่อหรือเริ่มแบ่งเวลาครับ?",
            "seed_comment": "การพักไม่ใช่ความเห็นแก่ตัว เคสนี้ควรกำหนดเวลาของตัวเองให้ชัดครับ",
        },
    ],
}

FIRST_PERSON_TERMS = ("ผม", "ฉัน", "ดิฉัน", "หนู", "เรา")
...
def get_third_person_fallback(slot):
    choices = THIRD_PERSON_FALLBACKS.get(slot) or THIRD_PERSON_FALLBACKS["noon"]
    return random.choice(choices).copy()
...
def generate_threads_content(topic, slot):
    global API_ENABLED
    if not API_ENABLED:
        print("Using third-person fallback due to disabled API.")
        return get_third_person_fallback(slot)
    ...
    prompt = (
        ...
        "กฎมุมมองสำคัญที่สุด:\n"
        "   - เล่าด้วยมุมมองบุคคลที่สามเท่านั้น โดยระบุตัวละคร เช่น ชายคนหนึ่ง หญิงคนหนึ่ง ลูกคนหนึ่ง พนักงานคนหนึ่ง หรือคู่รักคู่หนึ่ง\n"
        "   - แอดมินเป็นผู้เล่าเรื่องที่พบเห็น/อ่านเจอมา ไม่ใช่เจ้าของเหตุการณ์ และห้ามแต่งว่าเคยประสบเหตุการณ์นั้นเอง\n"
        "   - ห้ามใช้สรรพนามบุคคลที่หนึ่งทุกส่วน เช่น 'ผม' 'เรา' 'ฉัน' 'หนู' 'พวกเรา' 'ตัวเรา' หรือ 'ของเรา'\n\n"
        ...
        "   - ใช้ภาษาพูดเป็นกันเอง สุภาพ ลงท้ายด้วย 'ครับ' ได้ แต่ต้องคงมุมมองบุคคลที่สามตลอด\n\n"
        "3. ความเห็นเปิดประเด็นคอมเมนต์ (seed_comment):\n"
        "   - เป็นข้อสรุปของแอดมินในฐานะผู้สังเกตการณ์ โดยไม่ใช้สรรพนามแทนตัวเอง และลงท้ายด้วย 'ครับ'\n"
        "   - ต้องแสดงจุดยืนเลือกข้างอย่างชัดเจนข้างใดข้างหนึ่งทันที เพื่อชวนเปิดศึก/ให้คนอื่นแย้งหรือสนับสนุน\n"
        "   - ห้ามประนีประนอมหรือตอบกลางๆ เด็ดขาด เช่น 'เคสนี้ควรหยุดแผนแต่งงานจนกว่าจะเห็นแผนใช้หนี้ชัดเจนครับ' หรือ 'ความกตัญญูไม่ควรทำให้ลูกต้องเป็นหนี้ เคสนี้ควรช่วยเท่าที่กำลังไหวครับ'\n"
        ...
        for attempt in range(3):
            try:
                ...
                if image_line1 and caption and seed_comment:
                    ...
                    if any(
                        contains_first_person(text)
                        for text in (image_line1, image_line2, caption, seed_comment)
                    ):
                        print("[Rejected] Generated Threads content is not fully third-person.")
                        continue
    ...
    print("Using third-person fallback due to generation failure.")
    return get_third_person_fallback(slot)

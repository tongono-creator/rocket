...
def analyze_meme_to_scenario(img_path, reddit_title, recent_topics=None):
    ...
    prompt = (
        ...
        "1. label1_th: ข้อความพาดหัวภาษาไทยของช่องที่ 1 (สั้นกระชับ 3-7 คำ อธิบายบริบทความหวัง/ช่วงแรก จากมีมต้นฉบับ)\n"
        "2. scene1_en: คำอธิบายภาพช่องที่ 1 เป็นภาษาอังกฤษ (15-25 คำ) เพื่อใช้ป้อนให้ AI วาดรูป (ตัวละครหลักกำลังทำกิจกรรมหรือมีอารมณ์ตามมีมต้นฉบับช่องแรก เช่น Thai man in 30s trying to do X, looking hopeful)\n"
        "3. label2_th: ข้อความพาดหัวภาษาไทยของช่องที่ 2 (สั้นกระชับ 3-7 คำ อธิบายความจริงอันโหดร้าย/จุดหักมุม จากมีมต้นฉบับ)\n"
        "4. scene2_en: คำอธิบายภาพช่องที่ 2 เป็นภาษาอังกฤษ (15-25 คำ) เพื่อใช้ป้อนให้ AI วาดรูป (ตัวละครหลักสีหน้าหรืออารมณ์ตามมีมต้นฉบับช่องที่สอง เช่น Same Thai man in panic because of Y)\n"
        "5. caption: แคปชั่นภาษาไทย 1 ย่อหน้าสั้นๆ (2-4 ประโยค) สไตล์แอดมินเพจผู้ชาย (ใช้หางเสียงครับ/ผม/พี่ เสมอ) อธิบายขยายความมุกตลกจากมีมนี้ชวนคุยให้คนกดคอมเมนต์แชร์เรื่องตัวเองเกี่ยวกับมุกนี้ ท้ายข้อความใส่แฮชแท็ก 2-3 อันที่เกี่ยวข้องกับมุกนี้โดยตรง\n\n"

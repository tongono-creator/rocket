...
def analyze_meme_to_scenario(img_path, reddit_title, recent_topics=None):
    ...
    prompt = (
        ...
        "   - ช่อง 1 (panel1_text) = Setup: สร้างความคาดหวังหรือปูเรื่อง\n"
        "   - ช่อง 2 (panel2_text) = Punchline: หักมุม ตลกร้าย หรือความจริงอันเจ็บจี๊ด แทงใจคนอ่านทันที ไม่ใช่แค่เล่าเหตุการณ์ต่อเฉยๆ\n"
        "3. **ข้อความบนรูปภาพต้องสั้นมาก**: ใช้ภาษาพูดที่เป็นกันเอง/ภาษาปากสั้นๆ กระชับ ห้ามเขียนประโยคยาว ห้ามใส่คำบรรยายยืดยาว และห้ามเกิน 12 คำภาษาไทยต่อช่อง\n"
        "4. **การเชื่อมโยงบริบทออฟฟิศไทย (Localization)**: ปรับประเด็นใน Reddit ให้โยงกับชีวิตจริงของคนทำงานไทย เช่น เด็กฝาก, คนใน, เปิดรับสมัครตามพิธี, หัวหน้า, KPI, เงินเดือน, ประชุม, OT, HR, โปรโมชัน, สัมภาษณ์งาน\n"
        "5. **ช่องที่ 2 ต้องสื่อภาพ Punchline ด้วยตัวเอง**: คำอธิบายภาพช่อง 2 (panel2_scene) ต้องกำชับให้เห็นพฤติกรรมหรือฉากหลังที่สื่อถึงมุกหักมุม/ความไม่ยุติธรรมอย่างชัดเจน (เช่น HR สัมภาษณ์เด็กฝากอย่างสนิทสนมจนออกนอกหน้า, หัวหน้ากำลังชื่นชมคนพูดเก่งที่แย่งเครดิตงาน, หรือป้ายกระดาษสรุปที่ชัดเจน)\n"
        "6. **ห้ามมีมบอสสั่งงานด่วนในวันหยุดซ้ำซาก**: ยกเว้นแต่มีมต้นฉบับพูดถึงเรื่องนี้โดยตรง\n"
        f"{recent_topics_str}\n"
        "**กฎเหล็กสำหรับแคปชั่น (Caption Rules)**:\n"
        "- เขียนเหมือนคนจริงมาเล่า/แชร์ประสบการณ์ในกลุ่ม ไม่ใช่บทความ ไม่ใช่ข่าว ไม่ใช่คำชี้แจง\n"
        "- ความยาว 3-5 ย่อหน้าสั้น\n"
        "- เปิดด้วยสถานการณ์ที่เข้าใจได้ทันที\n"
        "- ต้องมีความขัดแย้ง/ความลังเลชัดเจน (เช่น เงิน vs เพื่อน / ครอบครัว vs ความเกรงใจ)\n"
        "- ห้ามใช้ Bullet point หรือการจัดรายการ\n"
        "- ห้ามใส่ Hashtag ใดๆ ทั้งสิ้นในตัวแคปชั่น\n"
        "- ห้ามใช้คำว่า ดราม่า, ช็อก, ไวรัล, ปัญหาสังคม หรือคำแนว AI/บอต สปอยล์เนื้อหา\n"
        "- ห้ามสรุปสอนศีลธรรมหรือเทศนาคำคมชีวิต\n"
        "- ต้องมีประโยคที่กระตุ้นให้คนอ่านรู้สึกว่า \"เรื่องนี้สามารถเกิดกับตัวเราหรือใครก็ได้\"\n"
        "- ภาษาเป็นผู้ชายสุภาพและเป็นกันเอง ใช้ ครับ / ผม / พี่ๆ เสมอ\n"
        "- จบด้วยคำถามท้ายโพสต์ที่บังคับให้คนอ่านเลือกข้าง ตอบทันที หรือเล่าประสบการณ์ตรง (เช่น \"ถ้าเป็นพี่ๆ จะทวงไหมครับ หรือยอมเสียเงินเพื่อรักษาเพื่อนไว้?\", \"แบบนี้ควรเรียกว่าเปิดรับสมัครจริง หรือเปิดให้ครบพิธีครับ?\")\n\n"
        ...
        "6. caption: แคปชั่นภาษาไทย 3-5 ย่อหน้าสั้นสไตล์ผู้ชายสุภาพ ดึงดูดคอมเมนต์ ไม่สปอยล์คำจบการ์ตูน ไร้แฮชแท็ก ไร้บลูเล็ต\n\n"
